...
> Design notes for **commerce-session-ledger** — a runnable go example that Email signup and server-side sessions feeding an order fulfillment ledger in Go.
...
- **Feature code** — the actual task: signup-to-fulfillment.
